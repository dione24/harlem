            ...
            <div class="box box-info">
                <div class="box-header with-border">
                    ...
                    <form class="form-horizontal" method="POST">
                        <?php if (isset($reparation)) { ?>
                        <input type="hidden" name="id_vente" value="<?= $reparation['RefVente']; ?>">
                        <?php } ?>
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <select id="vente_pieces" name="vente_pieces[]" multiple class="form-control">
                                        <?php foreach ($pieces as $piece) { ?>
                                        <option value="<?= $piece['RefPieces']; ?>"
                                            <?= (isset($reparation) && in_array($piece['RefPieces'], $v_pieces)) ? 'selected' : ''; ?>>
