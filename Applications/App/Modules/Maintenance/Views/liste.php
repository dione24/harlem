        ...
        <div class="col-xs-12">
            <div class="box">
                <div class="box-header">
                    ...
                    <a href="/Maintenance/add" class="btn btn-sm btn-success" style="float: right;"><i class="fa fa-plus"></i></a>
                </div>
                <div class="box-body">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="/Maintenance/update/<?= $maintenance['RefMaintenance']; ?>" class="btn btn-xs btn-primary"><i class="fa fa-edit"></i></a>
                                    <a href="/Maintenance/delete/<?= $maintenance['RefMaintenance']; ?>" class="btn btn-xs btn-danger" onclick="return confirm('Êtes-vous sûr de vouloir supprimer cet élément ?');"><i class="fa fa-trash"></i></a>
                                </td>
                            </tr>
                            <?php } ?>
                        </tbody>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="POST">
                    ...
                    <div class="form-group">
                        <label>
                            <input type="radio" name="statut" placeholder="Entrer le nom de la pièce" <?= ($maintenance['RefStatut']==2)?'checked':''; ?> value="2" class="statut_reglee-<?= $maintenance['RefMaintenance']; ?>">
                            Reglée
                        </label>
                    </div>
